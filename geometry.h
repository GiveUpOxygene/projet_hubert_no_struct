...
{
    float v1[2]; float v2[];
    Vector2 a = SubVector2(&(seg1[1]), &(seg1[0]), v1);
    Vector2 b = SubVector2(&(seg2[1]), &(seg2[0]), v2);
...
Segment* ToSegment(const float points[][2], int length, Segment* seg)
{
...
void GetSegmentEquation(const Segment* segment, float equation[])
{
